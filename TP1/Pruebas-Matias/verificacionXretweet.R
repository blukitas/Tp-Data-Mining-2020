...
<<<<<<< HEAD:Pruebas-Matias/verificacionXretweet.R
...
=======
a2 <- data_filtrada_3_b_top100
>>>>>>> 932e6107f24396849b50d94d6ddb1118526f781f:TP1/Pruebas-Matias/verificacionXretweet.R
#nrow(a1)
...
#nrow(a1NotIna2)
nrow(a1Ina2)
porcentage_positivos <- nrow(a1Ina2)
#porcentage_positivos <- nrow(a1Ina2) / 763 * 100
